...
export default function Area({
    ...
    const getDetailRoute = (name) => {
        return provinceCode 
            ? route(`monitoring.area.${name}`, provinceCode) 
            : route(`monitoring.nasional.${name}`);
    };
    ...
    const STATS = [
        {
            ...
            sub: null,
            trend: null,
            detailHref: getDetailRoute("sekolah"),
        },
        {
            ...
            trend: null,
            detailHref: getDetailRoute("customer-aktif"),
        },
        {
            label: "Coverage",
            value: coveragePct,
            ...
            sub: `${coveragePct} dari Total Sekolah`,
            trend: null,
            detailHref: getDetailRoute("coverage"),
        },
        {
            label: "Opportunity",
            ...
            trend: null,
            detailHref: getDetailRoute("opportunity"),
        },
        {
            ...
            sub: null,
            trend: null,
            detailHref: getDetailRoute("target-eksemplar"),
        },
        {
            ...
            sub: null,
            trend: null,
            detailHref: getDetailRoute("siswa"),
        },
    ];
                        ...
                        >
                                ...
                                {!isSalesDetail && !isFromSalesPerformance && (
                                    <Card
                                        ...
                                        headerAction={
                                            ...
                                            >
                                                <Link
                                                    href={getDetailRoute("sales-jenjang")}
                                                    style={{
                                                        fontSize: 10,
                                                        color: T.blue,
                                                        textDecoration: "none",
                                                ...
                                                <Link
                                                    href={getDetailRoute("sales-jenjang-kecamatan")}
                                                    style={{
                                                        fontSize: 10,
                                                        color: T.blueSoft,
                                                        textDecoration: "none",
                            ...
                            >
                                ...
                                <Card
                                    ...
                                    headerAction={
                                        <Link
                                            href={getDetailRoute("sumber-dana")}
                                            style={{
                                                fontSize: 10,
                                                color: T.blue,
                                                fontWeight: 600,
