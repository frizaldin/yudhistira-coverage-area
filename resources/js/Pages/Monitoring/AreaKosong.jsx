...
export default function AreaKosong({ customers, areas, cabangs, filters }) {
    ...
    const applyFilters = useCallback(
        debounce((newSearch, newArea, newCabang) => {
            const query = {};
            if (newSearch) query.search = newSearch;
            if (newArea) query.area_id = newArea;
            if (newCabang) query.cabang_id = newCabang;
            
            router.get(route('monitoring.area-kosong'), query, {
                preserveState: true,
                replace: true,
            });
        }, 500),
    ...
    useEffect(() => {
        applyFilters(search, areaId, cabangId);
    }, [search, areaId, cabangId, applyFilters]);

    return (
        <MonitoringLayout activeNav="area-kosong">
            <Head title="Area Cover Kosong" />
            <div style={{ padding: "30px", maxWidth: "1200px", margin: "0 auto" }}>
                ...
                <div style={{ marginBottom: "24px" }}>
                    ...
                    <p style={{ color: "#64748b", marginTop: "4px" }}>Daftar customer/sekolah yang tidak terpegang oleh sales manapun dan tidak terpegang oleh kompetitor manapun.</p>
                </div>
