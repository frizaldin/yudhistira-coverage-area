...
function Donut({ segments, size = 120, ring = 26, label, sub }) {
    ...
    return (
        ...
        >
            ...
            {hoveredInfo && typeof window !== "undefined" && createPortal(
                <div
                    style={{
                        position: "fixed",
                        left: mousePos.x + 15,
                ...
                >
                    <div style={{ fontSize: 11, fontWeight: 700, color: hoveredInfo.color, marginBottom: 4 }}>
                        {hoveredInfo.label}
                    </div>
                    <div style={{ display: "flex", alignItems: "baseline", gap: 6 }}>
                        <span style={{ fontSize: 14, fontWeight: 800, color: T.text, lineHeight: 1 }}>
                            {hoveredInfo.percent}%
                        </span>
                        <span style={{ fontSize: 11, fontWeight: 500, color: T.slate }}>
...
function KecamatanChoroplethMap({ salesId, cabangId, listKecamatan = [] }) {
    ...
    const getBadge = (pct) => {
        if (pct >= 70) return { text: "Tinggi", bg: "#d1fae5", color: "#065f46" };
        if (pct >= 30) return { text: "Sedang", bg: "#dbeafe", color: "#1e40af" };
        if (pct >= 10) return { text: "Rendah", bg: "#fef3c7", color: "#92400e" };
        if (pct > 0) return { text: "Sangat Rendah", bg: "#ffedd5", color: "#9a3412" };
    ...
    useEffect(() => {
        ...
        try {
            fetchUrl = route("monitoring.sales-performance.geojson", Object.fromEntries(params));
        } catch(e) {
...
/* ── COMPOSITION CARD ── */
function CompositionCard({ title, data }) {
    ...
    return (
        <MonitoringLayout activeNav={activeNav}>
                ...
                >
                    {(isSalesDetail
                        ? [
                              ...
                              {
                                  id: "rekomendasi",
                                  label: `Prediksi ${predictionYear}`,
                              },
                              { id: "analisa", label: "Analisa & Grading" },
                          ]
                        : [
                              { id: "dashboard", label: "Dashboard Utama" },
                              {
            ...
            >
                {activeTab === "dashboard" && (
                    <>
                            ...
                            >
                                ...
                                >
                                    <KecamatanChoroplethMap
                                        salesId={salesPerformanceFilters?.sales_id}
                                        cabangId={cabangCode}
                        ...
                        <div style={{ display: "flex", gap: 10 }}>
                            ...
                            >
                                <Card title="Rencana Jual vs Area Cover">
                                    <div
                                        style={{
                                            display: "flex",
                                            alignItems: "center",
                                    ...
                                    >
                                        <Donut
                                            segments={rencanaJualCoverage}
                                            size={80}
                                            ring={12}
                                            label={
                                                (rencanaJualCoverage[0]
                                                    ?.value || 0) +
                                                (rencanaJualCoverage[1]
                                                    ?.value || 0)
                                            }
                                            sub="Sekolah"
                                        />
                                        <div style={{ flex: 1 }}>
                                            {rencanaJualCoverage.map(
                                                (item, idx) => (
                                                    <div
                                                        key={idx}
                                                        style={{
                        ...
                        {isSalesDetail && (
                            ...
                            >
                                ...
                                <Card
                                    title="Realisasi Sekolah (3 Tahun Terakhir)"
                                    style={{ flex: 1 }}
                                    noPad
                                >
                                    <div
                                        ...
                                        >
                                            ...
                                            <tbody>
                                                ...
                                                listSekolah.length > 0 ? (
                                                    listSekolah
                                                        .slice(
                                                            (realisasiSekolahPage -
                                                                1) *
                                                                realisasiSekolahPerPage,
                                                            realisasiSekolahPage *
                                                                realisasiSekolahPerPage,
                                                        )
                                                        .map((s, idx) => {
                        ...
                        {isSalesDetail && (
                            ...
                            >
                                <CompositionCard
                                    ...
                                    data={jenjangBreakdown}
                                />
                                <CompositionCard
                                    title="Komposisi Sumber Dana"
                                    data={sumberDanaBreakdown}
                                />
                                <CompositionCard
                                    title="Komposisi Grade (Potensi)"
                                    data={segmenBreakdown}
                                />
                                <CompositionCard
                                    title="Komposisi Jumlah Siswa"
                                    data={siswaBreakdown}
                                />
                            </div>
                        )}
                        ...
                        {isSalesDetail && (
                            ...
                            >
                                <Card
                                    title={`Area Cover: ${listKecamatan.length} Kecamatan`}
                                ...
                                <Card
                                    title="Top 10 Sekolah (Realisasi)"
                                    style={{ flex: 1.5, minWidth: 350 }}
                                    noPad
                                >
                ...
                {/* ── REKOMENDASI / PREDIKSI DYNAMIC ── */}
                {activeTab === "rekomendasi" && isSalesDetail && (
                    <div className="animate-fade-in mt-4">
                        {/* <FilterSectionRekomendasi /> */}
                        {(() => {
                            // Find active kecamatans for proximity indication
                            const activeKecamatans = new Set(
                                (listSekolah || [])
                                    .filter(
                                        (s) => s.is_active && s.kecamatan_name,
                                    )
                                    .map((s) => s.kecamatan_name),
                            );

                            // Get non-cover schools
                            let rekomendasi = nonCoverSchools || [];

                            // Sort by clicked column, fallback to proximity if sorting by total_student
                            rekomendasi.sort((a, b) => {
                                const dir =
                                    rekomendasiSort.dir === "asc" ? 1 : -1;

                                if (rekomendasiSort.key === "name") {
                                    return (
                                        dir *
                                ...
                                if (rekomendasiSort.key === "kecamatan_name") {
                                    return (
                                        dir *
                                        (a.kecamatan_name || "").localeCompare(
                                            b.kecamatan_name || "",
                                        )
                                    );
                                }

                                // Default or if sorting by total_student, apply proximity logic if descending
                                const aDekat = activeKecamatans.has(
                                    a.kecamatan_name,
                                )
                                    ? 1
                                    : 0;
                                const bDekat = activeKecamatans.has(
                                    b.kecamatan_name,
                                )
                                    ? 1
                                    : 0;
                                if (
                                    aDekat !== bDekat &&
                                    rekomendasiSort.key === "total_student" &&
                                    dir === -1
                                ) {
                                    return bDekat - aDekat;
                                }
                            ...
                            const handleRekomendasiSort = (key) => {
                                if (rekomendasiSort.key === key) {
                                    setRekomendasiSort({
                                        key,
                                        dir:
                                            rekomendasiSort.dir === "asc"
                                                ? "desc"
                                                : "asc",
                                    });
                                } else {
                                    // Default new sort is asc for names, desc for total_student
                                    setRekomendasiSort({
                                        key,
                                        dir:
                                            key === "total_student"
                            ...
                            const baseSekolah = (listSekolah || []).slice(
                                0,
                                40,
                            );
                            const terealisasi = baseSekolah.filter(
                                (s) => s.is_active,
                            ).length;
                            const belum = baseSekolah.length - terealisasi;
                            const totalBasis = baseSekolah.length;
                            return (
                                <>
                                    <div
                                        style={{
                                    ...
                                    >
                                        {/* Summary Cards */}
                                        <Card
                                            title={`Sudah Terealisasi ${targetYear}`}
                                            style={{
                                                flex: 1,
                                                minWidth: 200,
                                        ...
                                        >
                                            ...
                                            >
                                                Sekolah dengan realisasi di{" "}
                                                {targetYear}. Target{" "}
                                                {predictionYear}: Tahan.
                                            </div>
                                        </Card>
                                        <Card
                                            title={`Belum Terealisasi ${targetYear}`}
                                            style={{
                                                flex: 1,
                                                minWidth: 200,
                                        ...
                                        >
                                            ...
                                            >
                                                Belum ada realisasi. Target{" "}
                                                {predictionYear}: Rebut.
                                            </div>
                                        </Card>
                                        <Card
                                            title="Total Basis Sekolah"
                                            style={{
                                                flex: 1,
                                                minWidth: 200,
                                        ...
                                        >
                                            ...
                                            >
                                                Total target coverage acuan
                                                untuk prediksi.
                                            </div>
                                        </Card>
                                    </div>
                                    <Card
                                        title={`Rekomendasi Sekolah Non Cover (Potensi Akuisisi)`}
                                    >
                                        <div
                                            style={{
                                                width: "100%",
                                                ...
                                                <tbody>
                                                    {rekomendasi.length > 0 ? (
                                                        rekomendasi
                                                            .slice(0, 40)
                                                            .map((s, idx) => {
                                                                const historyField = `realisasi_${prevYear}`;
                                                                const hasHistory =
                                                                    !!s[
                                                                        historyField
                                                                    ];
                                                                const isDekat =
                                                                    activeKecamatans.has(
                                                                        s.kecamatan_name,
                                                                    );
                                                                return (
                                                                    <tr
                ...
                {activeTab === "analisa" && (
                    ...
                    >
                        {(() => {
                            // 1. Hit Rate Kunjungan ke Realisasi
                            // A. Kunjungan tanpa realisasi
                            const visitedCustomerIds = new Set(
                                (kegiatanSales || [])
                                    .map((k) => k.customer_id)
                                    .filter((id) => id),
                            );
                            const visitedUnrealized = (
                                listSekolah || []
                            ).filter(
                                (s) =>
                                    visitedCustomerIds.has(s.id) &&
                                    !s.is_active,
                            );

                            // B. Competitor Analytics
                            let totalBukuInternal = 0;
                            let totalSiswaAktif = 0;
                            (listSekolah || []).forEach((s) => {
                                if (s.is_active) {
                                    totalBukuInternal +=
                                        Number(s.real_exemplar_current) || 0;
                                    totalSiswaAktif += Number(s.total_student) || 0;
                                }
                            });

                            const totalPotensiBuku = totalSiswaAktif * 7;
                            const totalBukuKompetitor = Math.max(
                                0,
                                totalPotensiBuku - totalBukuInternal,
                            );
                            const marketShareInternal =
                                totalPotensiBuku > 0
                                    ? (
                                          (totalBukuInternal /
                                              totalPotensiBuku) *
                            ...
                            const marketShareKompetitor =
                                totalPotensiBuku > 0
                                    ...
                                    : 0;
                            // C. Grading System
                            // Score 1: Activity Coverage (visited schools / total active + potential schools, simplify to visited / total area basis)
                            ...
                            const activityCoverage = Math.min(
                                100,
                                (visitedCustomerIds.size / baseCount) * 100,
                            );

                            // Score 2: Hit rate (Active / Visited, capping at 100%)
                            const activeCount = (listSekolah || []).filter(
                                (s) => s.is_active,
                            ).length;
                            const hitRate =
                                visitedCustomerIds.size > 0
                                    ? Math.min(
                                          100,
                                          (activeCount /
                                              visitedCustomerIds.size) *
                                              100,
                                      )
                                    : 0;

                            // Final Score: 40% Coverage + 60% Hit Rate
                            const finalScore = Math.round(
                                activityCoverage * 0.4 + hitRate * 0.6,
                            );
                            ...
                            let gradeData = {
                                ...
                                bg: "#fef2f2",
                                title: "Merah (Kurang)",
                                msg: "Performa di bawah standar. Perlu sanksi atau teguran.",
                            };
                            if (finalScore >= 70) {
                                gradeData = {
                                    color: "#16a34a",
                                    bg: "#f0fdf4",
                                    title: "Hijau (Sangat Baik)",
                                    msg: "Aktivitas dan konversi sangat baik. Layak diberikan apresiasi/reward.",
                                };
                                ...
                                gradeData = {
                                    ...
                                    bg: "#fffbeb",
                                    title: "Kuning (Cukup)",
                                    msg: "Performa menengah. Perlu pembinaan intensif pada sekolah yang dikunjungi tapi belum deal.",
                                };
                            }
                            return (
                                <>
                                    ...
                                    <div style={{ display: "flex", gap: 16 }}>
                                        <Card
                                            style={{
                                                flex: 1,
                                                borderTop: `4px solid ${gradeData.color}`,
                                                background: gradeData.bg,
                                            }}
                                        >
                                            <div
                                                style={{
                                    ...
                                    <Card title="Estimasi Porsi Kompetitor (Berdasarkan Sekolah Terealisasi)">
                                        <div
                                            style={{
                                                display: "flex",
                                                gap: 24,
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                >
                                                    Dihitung dari sekolah yang{" "}
                                                    <strong>
                                                        sudah terealisasi
                                                    </strong>{" "}
                                                    di area ini. Asumsi 1 siswa
                                                    membutuhkan rata-rata 7 buku
                                                    utama per tahun. Jika
                                                    penjualan internal hanya
                                                    memenuhi sebagian, maka
                                                    sisanya adalah porsi
                                                    kompetitor.
                                                </p>
                                                <div
                                                    style={{
                                            ...
                                            {totalPotensiBuku > 0 && (
                                                ...
                                                >
                                                    <Donut
                                                        ...
                                                        segments={[
                                                            {
                                                                value: totalBukuInternal,
                                                                color: "#15803d",
                                                            },
                                                            {
                                                                value: totalBukuKompetitor,
                                                                color: "#ef4444",
                                                            },
                                                        ]}
                                                        label="Market Share"
                                    ...
                                    {/* Kunjungan Tanpa Realisasi */}
                                    <Card
                                        title={`Kunjungan Tanpa Realisasi (Indikasi Kebocoran Follow-up) - ${visitedUnrealized.length} Sekolah`}
                                    >
                                        <div
                                            style={{
                                                width: "100%",
                                        ...
                                        >
                                            ...
                                            >
                                                ...
                                                <tbody>
                                                    {visitedUnrealized.length >
                                                    0 ? (
                                                        visitedUnrealized.map(
                                                            (s, idx) => (
                                                                <tr
                                                                    key={idx}
                                                                    style={{
